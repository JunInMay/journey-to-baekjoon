...
for case in cases:
    ...
    base_floor_num = N % H
    floor_num = base_floor_num if base_floor_num != 0 else H

    base_room_num = N // H + 1 if N % H > 0 else N // H
    room_num = str(base_room_num) if base_room_num >= 10 else "0"+str(base_room_num)
